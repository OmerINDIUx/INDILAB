...
<html lang="es">
  <head>
    <meta charset="UTF-8" />
    <title>INDI Lab - Coming Soon</title>
...
===================== */
   ...
   ===================== */
    ...
    <meta
      ...
      content="aAM5tigcEfaCe8zQagC7uLQgQrQ1Pcs2EfJi_JwAAsM"
    />
  </head>
  ...
  <body>
    <section>
      <div class="secundary-logo">
        <div class="indi-lab-logo" data-svg="{{ asset('svg/INDI_LAB_P.svg') }}"></div>
      </div>
      <!-- FRASES -->
      <div class="headline">
        <h1 class="titulo"></h1>
  ...
  =========================================================== -->
    ...
    <a href="{{ route('home') }}" class="home-button">Regresar al Inicio</a>
